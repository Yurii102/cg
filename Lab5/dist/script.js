...
window.onload = () => {
    ...
    function explainMatrixMultiplication(m1, m2, m1Name, m2Name) {
    ...
    function formatMatrixSimple(matrix) {
        let result = "";
        for (let i = 0; i < 3; i++) {
    ...
    function saveTransformationMatrix() {
        ...
        if (animationType === "point") {
            ...
            let temp2 = multiplyMatrices(S, temp1);
            detailedExplanation += explainMatrixMultiplication(T2, temp2, "T2", "(S * M * T1)");
    ...
    function formatMatrix(matrix, animationType, vertexIndex, scaleFactor, pivotVertex, detailedExplanation) {
